...
/*
 ...
 Hello CMB iOS Developer...
 
 I wanted to write a file to answer some questions and clarify things I've done in the code for this submission.
 
 First off... Why the heck did I use SwiftJSON for the smallest of JSON files?
    Good Question: I did this intentionally to show that I understood how to utilize cocoapods, and work with a 3rd party framework. This is just 1 I've used before and it could be used for relevance in this project. However with a JSON file structure this simplistic, a few Guard statements and I would've been parsed out just fine and moving on but I wanted to show competency in 3rd party frameworks.
